export default {
  'about.title': 'CineFiles CollectionSpace',
  'about.contentHTML': `
    <p>
      Collections management system for the CineFiles collection of the UC Berkeley Art Museum and
  ...
  'vocab.location.local.name': 'Storage Location',
  ...
  'vocab.organization.local.name': 'Corporate Name',
